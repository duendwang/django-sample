...
def create_question(question_text, days):
    """
    Create a question with the given `question_text` and published the given given number of `days` offset to now (negative for questions published).
    """
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        self.assertEqual(response.status_coide, 404)
